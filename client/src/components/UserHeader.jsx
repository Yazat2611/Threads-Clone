import { Box, VStack,Flex, Avatar, Text, Link, MenuButton, Portal, MenuList, MenuItem,Menu, useToast, Button} from '@chakra-ui/react'
...
import useShowToast from "../hooks/useShow"
const UserHeader = ({user}) => {
    ...
    const copyUrl = () => {
        ...
        navigator.clipboard.writeText(curr).then(() => {
            // console.log("Copy hogya hai link");
    ...
    <VStack gap={4} alignItems={"start"}>
        ...
        <Flex w={"full"} justifyContent={"space-between"}>
            <Flex gap={2} alignItems={"center"}>
                ...
                <Box width="1" h="1" bg={"gray.light"} borderRadius={"full"}></Box>
